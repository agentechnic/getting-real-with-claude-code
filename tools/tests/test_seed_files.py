...
def test_claude_md_states_the_report_format_rule():
    text = (NUSSAA / "CLAUDE.md").read_text(encoding="utf-8")
...
def test_every_seed_file_is_actually_committed():
    ...
    The root .gitignore excludes CLAUDE.md, which silently swallowed
    nussaa/CLAUDE.md the first time it was committed. Everything an
