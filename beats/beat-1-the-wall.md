...
<!-- participant-start -->
## Do the job the way you already know how

Open [claude.ai](https://claude.ai) in a browser. Not the terminal. The chat box you have used a hundred times.

Now do your job: read a quarter of support tickets and tell me the themes.
...
You will hear people say the terminal version is "faster". It is not faster. It is a different shape.

Watch for the moment in the next beat when that difference stops being an argument and becomes obvious.
<!-- participant-end -->
