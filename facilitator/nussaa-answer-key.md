...
See `nussaa-dry-run.md` for the full comparison.
...
Seeded at 20260815, so it reproduces byte-identically. If you change anything
in `tools/corpus/spec.py`, every number on this page stops being true — rerun
